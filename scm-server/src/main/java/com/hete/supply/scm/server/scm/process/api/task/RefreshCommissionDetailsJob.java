...
@Slf4j
public class RefreshCommissionDetailsJob {
    private final ProcessOrderScanBizService processOrderScanBizService;

    @XxlJob(value = "refreshCommissionDetailsJob")
    public void execute() {
        String scanCompleteTimeStr = XxlJobHelper.getJobParam();
        processOrderScanBizService.refreshCommissionDetailsJob(scanCompleteTimeStr);
    }
}
