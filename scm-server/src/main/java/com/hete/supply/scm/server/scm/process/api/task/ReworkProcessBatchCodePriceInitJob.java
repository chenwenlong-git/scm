...
public class ReworkProcessBatchCodePriceInitJob {
    private final ProcessOrderItemBizService processOrderItemBizService;

    @XxlJob(value = "reworkProcessBatchCodePriceInitTask")
    public void execute() {
        ...
        if (StrUtil.isNotBlank(ponStr)) {
            ...
            processOrderItemBizService.initializeBatchCodePricesByTypes(
                    Set.of(ProcessOrderType.REWORKING, ProcessOrderType.LIMITED_REWORKING));
        }
    }
}
