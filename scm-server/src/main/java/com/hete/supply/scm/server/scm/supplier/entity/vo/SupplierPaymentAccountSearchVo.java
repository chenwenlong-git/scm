...
@Data
@NoArgsConstructor
public class SupplierPaymentAccountSearchVo {
    ...
    @ApiModelProperty(value = "审批单据列表")
    private List<SupplierPaymentAccountAuditOrderVo> supplierPaymentAccountAuditOrderList;

    @Data
    public static class SupplierPaymentAccountAuditOrderVo {
