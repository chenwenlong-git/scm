...
public class AfterDeliverRawStrategy implements PurchaseRawStrategy {
    ...
    public void dealSplitPurchaseRaw(List<PurchaseChildOrderRawPo> newPurchaseChildOrderRawPoList,
        ...
        final Consumer<PurchaseChildOrderRawPo> purchaseChildOrderRawPoConsumer = newRawPo -> {
        ...
        newPurchaseChildOrderRawPoList.forEach(purchaseChildOrderRawPoConsumer);
        // 清空id
        ...
        // 继承原料出库信息
        final List<PurchaseChildOrderRawDeliverPo> newPurchasePoRawDeliverList = purchaseChildOrderRawDeliverDao.getListByChildOrderNo(newPurchaseChildOrderPo.getPurchaseChildOrderNo());
    ...
    public PurchaseSplitRaw getHandlerType() {
        return PurchaseSplitRaw.AFTER_DELIVER;
    }
}
