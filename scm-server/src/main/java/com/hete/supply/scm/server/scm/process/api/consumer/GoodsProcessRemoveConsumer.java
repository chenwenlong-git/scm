 ...
 */
@Component
@RocketMQMessageListener(topic = "topic_plm", selectorExpression = "tag_goods_remove_spu", consumerGroup = "scm_tag_goods_remove_spu_consumer")
@RequiredArgsConstructor
public class GoodsProcessRemoveConsumer extends BaseMqListener<GoodsProcessMqDto> {
    ...
    public void handleMessage(GoodsProcessMqDto message) {
        goodsProcessBizService.sync(message, true);
    }
}
