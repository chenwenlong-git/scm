...
@Data
@NoArgsConstructor
public class SupplierPaymentAccountCreateDto {
    ...
    @Length(max = 255, message = "备注长度不能超过 255 位")
    ...
    private List<@NotBlank(message = "企业营业执照值不能为空") String> companyFileCodeList;

    @ApiModelProperty(value = "身份证照片正反面")
    private List<@NotBlank(message = "身份证照片正反面值不能为空") String> personalFileCodeList;

    @ApiModelProperty(value = "收款授权书")
    private List<@NotBlank(message = "收款授权书值不能为空") String> authFileCodeList;
