...
@TableName("deduct_order_purchase")
@ApiModel(value = "DeductOrderPurchasePo对象", description = "扣款单采购明细")
public class DeductOrderPurchasePo extends BasePo {


    @ApiModelProperty(value = "主键id")
    @TableId(value = "deduct_order_purchase_id", type = IdType.ASSIGN_ID)
