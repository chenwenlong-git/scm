...
import com.hete.supply.scm.server.scm.process.entity.dto.RepairOrderInStorageDto;
...
@Slf4j
@Component
public class ReOrderInsHandler implements AsyncSendMqHandler<RepairOrderInStorageDto> {
    private String beanName;

    @Override
    public void failed(@NotNull @Valid RepairOrderInStorageDto request,
